define(['react', 'reactDom'], function(React, ReactDOM) {
  ...
  var Ctrl = function(scope, log, interval, stateParams) {  
    ...
    var CellBlock = React.createClass({displayName: "CellBlock",
      render: function() {
    ...
    var ColumnGrid = React.createClass({displayName: "ColumnGrid",
      render: function() {
        ...
        return (
          React.createElement("div", {className: "row"}, 
            columns.map(function(column, id) {
               return (
                React.createElement("div", {className: "col-md-1 thumbnail inline-center"}, 
                  React.createElement(CellBlock, {column: "{column}", row: "{this.props.row}"})
                )
              );
            })
          )
    ...
    var RowGrid = React.createClass({displayName: "RowGrid",
  	  render: function() {     
  	  	var rowList = rows.map(function(row, id) {
          return React.createElement(ColumnGrid, {info: "{row}"})
  	  	});
  	    return React.createElement("span", null, rowList);
  	  }
	});
  
  ReactDOM.render(
    React.createElement(RowGrid, null),
